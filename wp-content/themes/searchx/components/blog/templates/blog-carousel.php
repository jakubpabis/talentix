...
/**
 * Template Name: Blog Cards Carousel
 */
?>

<?php $the_query = component_query(); ?>

<div <?php component_row('align-items-center mb-sm-6 mb-0'); ?>>
	...
	<div <?php component_col('col-lg-4 col-12 text-lg-end d-lg-block d-none'); ?> data-aos="fade-up">
